...
$(".part01").height($(window).height()-55),
window.onload=function(){
	$(".nav-wrap").css({display:"block"}).addClass("on"),
	pageCom.resizeOtherImg($("#slogan")),
	pageCom.resizeOtherImg($(".slogan-wrap")),
	pageCom.resizeOtherImg($(".down-wrap")),
	pageCom.resizeOtherImg($(".or-btn")),
	pageCom.resizeOtherImg($(".logo")),
	setTimeout(function(){
		pageCom.resizeOtherImg($(".nav-wrap .nav")),
		pageCom.resizeOtherImg($("img.i-nav-icon1")),
		pageCom.resizeOtherImg($("img.i-nav-icon2")),
		pageCom.resizeOtherImg($("img.i-nav-icon3")),
		pageCom.resizeOtherImg($("img.i-nav-icon4")),
		pageCom.resizeOtherImg($("img.i-nav-icon5")),
		pageCom.resizeOtherImg($("img.i-nav-icon6")),
		pageCom.init()
	},30)
},
$(".gif-btn .close").bind("click",function(){
	$(".gif-btn").hide()
});

$(".tips-on").mouseenter(function(){
	$(".tips-on").css("display","none"),$(".tips-off").stop().animate({right:0},200)
}),
$(".tips-off").mouseleave(function(){
	$(".tips-on").css("display","block"),
	$(".tips-off").stop().animate({right:-177},200)
});

var n="xiaolifeidao(g38)-lunhuan-668819";

ADBase.config({
	pos:n,
	callback:function(e,t){
		if(0==e)return!1;
		for(var i=t[n],a="",o="",s=0;s<i.length;s++){
			var r=i[s];a+='<li><a href="'+r.url+'" title="'+r.title+'"><img src="'+r.src+'" /></a></li>',o+=0==s?'<span class="on"></span>':"<span></span>"
		}
		$(".banner ul").html(a),
		$(".b-index").html(o),
		$(".banner-wrap").slide({
			titCell:".b-index span",
			mainCell:".banner ul",
			effect:"left",
			autoPlay:!0,
			delayTime:1e3,
...
var a,o=nie.require("nie.util.videoV2");

$("#yy dt, .play-btn").bind("click",function(){
	var e=$(this).attr("data-mp4");
	a=o({
		fat:"#mp4",
		width:"720",
		height:"406",
	...
	pageCom.popLayer.popWindow("video-layer")
}),
$("#video-layer .close").bind("click",function(){
	pageCom.popLayer.popClose("video-layer"),a.destroy()
})