	...
	t.extend(t,
	{
		md5: function(t)
		{
			var e, i, o, r, a, h, g, p, y, w = Array(),
				...
				R = 15,
				U = 21;
			for (t = m(t), w = d(t), h = 1732584193, g = 4023233417, p = 2562383102, y = 271733878, e = 0; e < w.length; e += 16) i = h, o = g, r = p, a = y, h = c(h, g, p, y, w[e + 0], x, 3614090360), y = c(y, h, g, p, w[e + 1], b, 3905402710), p = c(p, y, h, g, w[e + 2], v, 606105819), g = c(g, p, y, h, w[e + 3], _, 3250441966), h = c(h, g, p, y, w[e + 4], x, 4118548399), y = c(y, h, g, p, w[e + 5], b, 1200080426), p = c(p, y, h, g, w[e + 6], v, 2821735955), g = c(g, p, y, h, w[e + 7], _, 4249261313), h = c(h, g, p, y, w[e + 8], x, 1770035416), y = c(y, h, g, p, w[e + 9], b, 2336552879), p = c(p, y, h, g, w[e + 10], v, 4294925233), g = c(g, p, y, h, w[e + 11], _, 2304563134), h = c(h, g, p, y, w[e + 12], x, 1804603682), y = c(y, h, g, p, w[e + 13], b, 4254626195), p = c(p, y, h, g, w[e + 14], v, 2792965006), g = c(g, p, y, h, w[e + 15], _, 1236535329), h = u(h, g, p, y, w[e + 1], S, 4129170786), y = u(y, h, g, p, w[e + 6], k, 3225465664), p = u(p, y, h, g, w[e + 11], j, 643717713), g = u(g, p, y, h, w[e + 0], q, 3921069994), h = u(h, g, p, y, w[e + 5], S, 3593408605), y = u(y, h, g, p, w[e + 10], k, 38016083), p = u(p, y, h, g, w[e + 15], j, 3634488961), g = u(g, p, y, h, w[e + 4], q, 3889429448), h = u(h, g, p, y, w[e + 9], S, 568446438), y = u(y, h, g, p, w[e + 14], k, 3275163606), p = u(p, y, h, g, w[e + 3], j, 4107603335), g = u(g, p, y, h, w[e + 8], q, 1163531501), h = u(h, g, p, y, w[e + 13], S, 2850285829), y = u(y, h, g, p, w[e + 2], k, 4243563512), p = u(p, y, h, g, w[e + 7], j, 1735328473), g = u(g, p, y, h, w[e + 12], q, 2368359562), h = s(h, g, p, y, w[e + 5], z, 4294588738), y = s(y, h, g, p, w[e + 8], C, 2272392833), p = s(p, y, h, g, w[e + 11], L, 1839030562), g = s(g, p, y, h, w[e + 14], D, 4259657740), h = s(h, g, p, y, w[e + 1], z, 2763975236), y = s(y, h, g, p, w[e + 4], C, 1272893353), p = s(p, y, h, g, w[e + 7], L, 4139469664), g = s(g, p, y, h, w[e + 10], D, 3200236656), h = s(h, g, p, y, w[e + 13], z, 681279174), y = s(y, h, g, p, w[e + 0], C, 3936430074), p = s(p, y, h, g, w[e + 3], L, 3572445317), g = s(g, p, y, h, w[e + 6], D, 76029189), h = s(h, g, p, y, w[e + 9], z, 3654602809), y = s(y, h, g, p, w[e + 12], C, 3873151461), p = s(p, y, h, g, w[e + 15], L, 530742520), g = s(g, p, y, h, w[e + 2], D, 3299628645), h = l(h, g, p, y, w[e + 0], T, 4096336452), y = l(y, h, g, p, w[e + 7], P, 1126891415), p = l(p, y, h, g, w[e + 14], R, 2878612391), g = l(g, p, y, h, w[e + 5], U, 4237533241), h = l(h, g, p, y, w[e + 12], T, 1700485571), y = l(y, h, g, p, w[e + 3], P, 2399980690), p = l(p, y, h, g, w[e + 10], R, 4293915773), g = l(g, p, y, h, w[e + 1], U, 2240044497), h = l(h, g, p, y, w[e + 8], T, 1873313359), y = l(y, h, g, p, w[e + 15], P, 4264355552), p = l(p, y, h, g, w[e + 6], R, 2734768916), g = l(g, p, y, h, w[e + 13], U, 1309151649), h = l(h, g, p, y, w[e + 4], T, 4149444226), y = l(y, h, g, p, w[e + 11], P, 3174756917), p = l(p, y, h, g, w[e + 2], R, 718787259), g = l(g, p, y, h, w[e + 9], U, 3951481745), h = n(h, i), g = n(g, o), p = n(p, r), y = n(y, a);
...
}, ! function(t)
{
	nie.util.stats = function()
	{
		...
		null != n && t.include("/qnm.163.com/static/mobile/js/ntes.js", function()
		{
		...
		function e()
		{
			...
			0 == n.length && i.length > 0 && (e = "m"), t.ajax(
			{
				...
				success: function(n)
				{
					...
					{
						2 == nie.config.copyRight.getStyle() && (n.result = n.result.replace(/(\/images\/([^\.\/]*)\.)\d{1}(\.png)/gi, "$12$3")), o(e, n.result)
					});
					else
					{
