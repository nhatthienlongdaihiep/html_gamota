	$(function(){
		...
		$(".tuku_nav a").click(function(){
			...
			var e=setInterval(function(){a+=1,4==a&&(a=0),$(".tuku_nav a").eq(a).click()},4e3);
			$(".tuku-wrap").hover(function(){clearInterval(e)},
			function(){
				e=setInterval(function(){
					a+=1,4==a&&(a=0),
					$(".tuku_nav a").eq(a).click()
				},4e3)
		}),
		...
		$("body").delegate(".tk_content li","mouseout",function(){
			$(this).find(".card_border").removeClass("animate"),$(this).find(".tuku_mask").stop(!0).fadeOut(300)
		}),t(0)
});